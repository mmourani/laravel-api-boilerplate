...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Contracts\TaskRepositoryInterface' => \App\Repositories\TaskRepository::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/user/Sites/saas-boilerplate/backend/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/user/Sites/saas-boilerplate/backend/public/storage',
...
'debugbar.debug_backtrace_limit','tinker.commands','tinker.alias','tinker.dont_alias',);
        registerArgumentsSet('middleware', 
'web','api','auth','auth.basic','auth.session',
'cache.headers','can','guest','password.confirm','precognitive',
'signed','throttle','verified','auth:sanctum',);
        registerArgumentsSet('routes', 
'debugbar.openhandler','debugbar.clockwork','debugbar.assets.css','debugbar.assets.js','debugbar.cache.delete',
'debugbar.queries.explain','sanctum.csrf-cookie','register','login',
'logout','projects.index','projects.store','projects.show','projects.update',
'projects.destroy','tasks.index','tasks.store','tasks.show',
'tasks.update','tasks.destroy','projects.tasks.index','projects.tasks.store','projects.tasks.show',
'projects.tasks.update','projects.tasks.destroy','storage.local',);
...
'LOG_JSON','DB_CONNECTION','DB_HOST','DB_PORT','DB_DATABASE',
...
'TELESCOPE_ENABLED','TELESCOPE_PATH','TELESCOPE_DRIVER','TELESCOPE_STORAGE','DEBUGBAR_ENABLED',
'DEBUGBAR_STORAGE_PATH','DEBUGBAR_CAPTURE_AJAX','DEBUGBAR_CAPTURE_CONSOLE','DEBUGBAR_SHOW_TIMELINE','XDEBUG_MODE',
'XDEBUG_CLIENT_HOST','XDEBUG_CLIENT_PORT',);
